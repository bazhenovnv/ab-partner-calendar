...
export function HighlightCarousel({
  ...
  if (!slides.length) {
    const fallback = (
      <div className='overflow-hidden rounded-[18px] border border-black bg-[#E8E7E3] shadow-[0_10px_28px_rgba(0,0,0,0.12)]'>
        <div className='grid min-h-[320px] gap-4 px-3 pt-3 pb-9 lg:grid-cols-2 lg:px-3 lg:pt-3 lg:pb-10'>
          <div className='min-h-[280px] overflow-hidden rounded-[22px] border border-black bg-[#E8E7E3] p-4'>
            <img src={IMPORTANT_EVENTS_PHOTO} alt='Важные события' className='h-full w-full object-contain object-center' />
          </div>

          <div className='flex flex-col justify-center rounded-[22px] border border-black bg-[#E8E7E3] p-6 text-black lg:p-8'>
    ...
    <div className='overflow-hidden rounded-[18px] border border-black bg-[#E8E7E3] shadow-[0_10px_28px_rgba(0,0,0,0.12)]'>
      <div className='relative grid min-h-[320px] gap-4 px-3 pt-3 pb-9 lg:grid-cols-[0.95fr_1fr] lg:px-3 lg:pt-3 lg:pb-10'>
        <button
          ...
          className='absolute left-3 top-1/2 z-10 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-[#E8E7E3]/10 text-white backdrop-blur transition hover:bg-[#E8E7E3]/16 lg:inline-flex'
        ...
        <button
          ...
          className='absolute right-3 top-1/2 z-10 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-[#E8E7E3]/10 text-white backdrop-blur transition hover:bg-[#E8E7E3]/16 lg:inline-flex'
        ...
        <div className='absolute bottom-3 left-1/2 flex -translate-x-1/2 items-center gap-3'>
          {slides.map((_, idx) => (
            <button
              ...
              className={`h-2.5 rounded-full transition-all ${idx === active ? 'w-8 bg-[#8BE2BE]' : 'w-2.5 bg-[#E8E7E3]/40 hover:bg-[#E8E7E3]/70'}`}
            />
          ))}
        </div>
      </div>
